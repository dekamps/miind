...
__global__ void CudaCalculateGridDerivativeFull(inttype N, fptype rate, fptype stays,fptype goes, inttype offset_1, inttype offset_2,fptype* derivative, fptype* mass);
