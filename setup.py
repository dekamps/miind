    ...
    if platform == "win32":
        cmake_args = (
            [
                ...
                '-DVCPKG_MANIFEST_MODE:BOOL=ON',
                '-DVCPKG_APPLOCAL_DEPS:BOOL=ON',
                '-DCMAKE_CUDA_FLAGS=-ccbin="C:\\Program Files (x86)\\Microsoft Visual Studio\\2019\\Enterprise\\VC\\Tools\\MSVC\\14.16.27023\\bin\\Hostx64\\x64" --generate-code=arch=compute_52,code=[compute_52,sm_52]',
