...
def function_overrides(outfile,tree,typ):
    ...
    outfile.write(reporting.define_display_nodes(tree,nodemap,looped_definition=True))
    outfile.write(reporting.define_rate_nodes(tree,nodemap,looped_definition=True))
    outfile.write(reporting.define_density_nodes(tree,nodemap,looped_definition=True))
    outfile.write('\t\t}\n')
    outfile.write('\n')
