...
(
	...
	*p_id_excitatory_main = network.addNode(algorithm_excitatory, EXCITATORY_GAUSSIAN);

	// Create inhibitory main population
	Algorithm algorithm_inhibitory(par_inh);
	*p_id_inhibitory_main = network.addNode(algorithm_inhibitory, INHIBITORY_GAUSSIAN);
